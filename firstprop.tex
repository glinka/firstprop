...
\begin{figure}[h!]
  ...
  %% \begin{minipage}{.5\textwidth}
  %%   \centering
  %%   \includegraphics[width=127mm]{rxnNetwork}
  %%   \captionof{figure}{}
  %%   \label{fig:rxnNetwork}
  %% \end{minipage}%
